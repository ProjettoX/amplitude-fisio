...
function PaginaProntuario({ pacientes, selecionadoId, onSelecionar, onAdicionar, onExcluir, onEditar }) {
    ...
    <div className="amp-shell">
      ...
      <main className="amp-main">
        ...
        <div className="amp-content">
          ...
          {!carregando && pagina === "pacientes" && <PaginaProntuario pacientes={pacientes} selecionadoId={selecionadoId} onSelecionar={setSelecionadoId} onAdicionar={adicionarPaciente} onExcluir={excluirPaciente} onEditar={editarPaciente} />}
